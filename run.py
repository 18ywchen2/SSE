...
def main(source_project, target_project):
    ...
    parser.add_argument("--code_length", default=427, type=int,
                        help="Optional Code input sequence length after tokenization.")
    parser.add_argument("--data_flow_length", default=85, type=int,
                        help="Optional Data Flow input sequence length after tokenization.")
    parser.add_argument("--code_snippets", default=5, type=int,
                        help="code_snippets.")
